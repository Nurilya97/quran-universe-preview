export const AYAH_PROTOTYPES = {
  '2:197': {
    reference: '2:197',
    surah: { ru: 'Аль-Бакара', en: 'Al-Baqarah', ar: 'البقرة' },
    focusRoot: 'و ق ي',
    ...
    tokens: [
      { ar: 'ٱلْحَجُّ', tr: 'al-ḥajju', ru: 'хадж', en: 'the Hajj', roleRu: 'существительное · marfūʿ', roleEn: 'noun · nominative' },
      { ar: 'أَشْهُرٌ', tr: 'ashhurun', ru: 'месяцы', en: 'months', roleRu: 'существительное · мн. число', roleEn: 'noun · plural' },
      { ar: 'مَّعْلُومَاتٌ', tr: 'maʿlūmātun', ru: 'известные / установленные', en: 'known / appointed', roleRu: 'прилагательное', roleEn: 'adjective' },
      { ar: 'فَمَن', tr: 'faman', ru: 'и тот, кто', en: 'then whoever', roleRu: 'فاء + условное местоимение', roleEn: 'resumption + conditional noun' },
      { ar: 'فَرَضَ', tr: 'faraḍa', ru: 'взял на себя / обязался', en: 'undertakes / commits', roleRu: 'глагол · прошедшее время', roleEn: 'perfect verb' },
      { ar: 'فِيهِنَّ', tr: 'fīhinna', ru: 'в них', en: 'in them', roleRu: 'предлог + местоимение', roleEn: 'preposition + pronoun' },
      { ar: 'ٱلْحَجَّ', tr: 'al-ḥajja', ru: 'хадж', en: 'the Hajj', roleRu: 'существительное · manṣūb', roleEn: 'noun · accusative' },
      { ar: 'فَلَا', tr: 'falā', ru: 'тогда нет / пусть не будет', en: 'then no', roleRu: 'فاء результата + отрицательная частица', roleEn: 'result particle + negation' },
      { ar: 'رَفَثَ', tr: 'rafatha', ru: 'интимной близости / непристойной речи', en: 'sexual relations / indecent speech', roleRu: 'существительное', roleEn: 'noun' },
      { ar: 'وَلَا', tr: 'walā', ru: 'и нет / и пусть не будет', en: 'and no', roleRu: 'союз + отрицательная частица', roleEn: 'conjunction + negation' },
      { ar: 'فُسُوقَ', tr: 'fusūqa', ru: 'неповиновения / греховного выхода', en: 'disobedience / sinful conduct', roleRu: 'существительное', roleEn: 'noun' },
      { ar: 'وَلَا', tr: 'walā', ru: 'и нет / и пусть не будет', en: 'and no', roleRu: 'союз + отрицательная частица', roleEn: 'conjunction + negation' },
      { ar: 'جِدَالَ', tr: 'jidāla', ru: 'спора', en: 'disputing', roleRu: 'существительное', roleEn: 'noun' },
      { ar: 'فِي', tr: 'fī', ru: 'во время / в', en: 'during / in', roleRu: 'предлог', roleEn: 'preposition' },
      { ar: 'ٱلْحَجِّ', tr: 'al-ḥajji', ru: 'хаджа', en: 'the Hajj', roleRu: 'существительное · majrūr', roleEn: 'noun · genitive' },
      { ar: 'وَمَا', tr: 'wamā', ru: 'и что бы ни', en: 'and whatever', roleRu: 'واو + условное местоимение', roleEn: 'resumption + conditional noun' },
      { ar: 'تَفْعَلُوا۟', tr: 'tafʿalū', ru: 'вы делаете', en: 'you do', roleRu: 'глагол · 2 л. мн. ч.', roleEn: 'verb · 2nd person plural' },
      { ar: 'مِنْ', tr: 'min', ru: 'из / какого-либо', en: 'of / any', roleRu: 'предлог', roleEn: 'preposition' },
      { ar: 'خَيْرٍۢ', tr: 'khayrin', ru: 'добра', en: 'good', roleRu: 'существительное', roleEn: 'noun' },
        ...
        analysis: {
          ru: {
            ...
            syntax: {
              ...
              case: 'مرفوع (marfūʿ) — грамматическое состояние, ожидаемое для خبر إِنَّ (khabar inna).',
    ...
    compositionThread: {
      ...
      en: 'The ayah ties the outward order of Hajj to a person’s inward state: appointed time → entering Hajj and its boundaries → Allah’s knowledge of actions → تَقْوَىٰ (taqwā) as inward provision → direct address to people of understanding.',
    },
    blocks: [
      {
        id: 'time',
        range: [1, 3],
        ru: {
          title: 'Хадж помещён в установленное время',
          text: 'ٱلْحَجُّ أَشْهُرٌ مَّعْلُومَاتٌ сначала задаёт рамку: хадж не происходит в абстрактном времени — для него есть известные месяцы.',
          bridge: 'Но сама временная рамка сразу ведёт к человеку, который входит в неё.',
        },
        en: {
          title: 'Hajj is placed inside an appointed time',
          text: 'ٱلْحَجُّ أَشْهُرٌ مَّعْلُومَاتٌ first establishes the frame: Hajj does not happen in abstract time; it has known months.',
          bridge: 'The time-frame immediately leads to the person who enters it.',
        },
      },
      {
        id: 'commitment-limits',
        range: [4, 15],
        ru: {
          title: 'Вступление в хадж меняет границы поведения',
          text: 'فَمَنْ فَرَضَ فِيهِنَّ ٱلْحَجَّ فَلَا... связывает решение вступить в хадж с последствиями: именно теперь называются три ограничения — رَفَث (rafath), فُسُوق (fusūq), جِدَال (jidāl).',
          bridge: 'Эти границы не остаются внешним списком правил: дальше аят помещает поступки человека под знание Аллаха.',
        },
        en: {
          title: 'Entering Hajj changes the boundaries of conduct',
          text: 'فَمَنْ فَرَضَ فِيهِنَّ ٱلْحَجَّ فَلَا... ties the decision to enter Hajj to its consequences: the three limits are now named—رَفَث (rafath), فُسُوق (fusūq), and جِدَال (jidāl).',
          bridge: 'The limits do not remain an external list; the ayah next places human action under Allah’s knowledge.',
        },
      },
      {
        id: 'knowledge',
        range: [16, 21],
        ru: {
          title: 'Поведение происходит перед знанием Аллаха',
          text: 'وَمَا تَفْعَلُوا مِنْ خَيْرٍ يَعْلَمْهُ ٱللَّهُ расширяет взгляд: речь уже не только о трёх запретах. Любое добро, которое человек делает в этом пути, известно Аллаху.',
          bridge: 'На этом фоне تَقْوَىٰ перестаёт быть отдельным словом: она отвечает на вопрос, какое внутреннее состояние помогает пройти путь в этих границах.',
        },
        en: {
          title: 'Conduct unfolds under Allah’s knowledge',
          text: 'وَمَا تَفْعَلُوا مِنْ خَيْرٍ يَعْلَمْهُ ٱللَّهُ widens the view beyond the three limits: whatever good a person does on this journey is known to Allah.',
          bridge: 'Against that background, تَقْوَىٰ is no longer an isolated word; it names the inward orientation by which the path can be lived within those boundaries.',
        },
      },
      {
        id: 'taqwa',
        range: [22, 26],
        ru: {
          title: 'Внешняя подготовка приводит к внутренней',
          text: 'وَتَزَوَّدُوا говорит о подготовке к пути, а فَإِنَّ خَيْرَ ٱلزَّادِ ٱلتَّقْوَىٰ сразу переносит смысл внутрь: лучшим زَاد (zād) названа تَقْوَىٰ (taqwā). В контексте предыдущих фраз это состояние осознанности перед Аллахом помогает удерживать установленные границы.',
          bridge: 'И аят не оставляет تَقْوَىٰ абстрактным качеством — следующим словом превращает её в обращённое к человеку действие.',
        },
        en: {
          title: 'Outward preparation leads to inward preparation',
          text: 'وَتَزَوَّدُوا speaks of preparing for the journey, while فَإِنَّ خَيْرَ ٱلزَّادِ ٱلتَّقْوَىٰ immediately turns inward: تَقْوَىٰ (taqwā) is named as the best زَاد (zād). In the flow of the preceding clauses, awareness before Allah is what helps a person remain within the stated boundaries.',
          bridge: 'The ayah does not leave تَقْوَىٰ as an abstract quality; the next phrase turns it into a direct action.',
        },
      },
      {
        id: 'address',
    ...
    passageLens: {
      ru: {
        ...
        thread: 'Для 2:197 особенно важно, что 2:196 завершается وَاتَّقُوا ٱللَّهَ وَٱعْلَمُوا… (wa-ttaqū Allāha wa-ʿlamū…), внутри 2:197 стоят يَعْلَمْهُ ٱللَّهُ (yaʿlamhu Allāh), ٱلتَّقْوَىٰ (al-taqwā) и وَٱتَّقُونِ (wa-ittaqūni), а 2:203 снова возвращает وَاتَّقُوا ٱللَّهَ وَٱعْلَمُوا…. То есть taqwā и знание проходят через весь хадж-блок как связанные ориентиры.',
        sound: 'Внутри этого же блока есть простая звуковая перекличка: 2:196 заканчивается словом ٱلْعِقَابِ (al-ʿiqāb), 2:197 — ٱلْأَلْبَابِ (al-albāb), 2:202 — ٱلْحِسَابِ (al-ḥisāb). Все три финала дают слышимое -āb / ب. Это не окончание каждого аята 2:196–203, а три заметные точки внутри одного смыслового блока о хадже.',
      },
      en: {
        ...
        sound: 'The same passage also contains a simple sound correspondence: 2:196 ends in ٱلْعِقَابِ (al-ʿiqāb), 2:197 in ٱلْأَلْبَابِ (al-albāb), and 2:202 in ٱلْحِسَابِ (al-ḥisāb). All three produce an audible -āb / ب ending. This is not the ending of every ayah in 2:196–203, but three noticeable anchor-points inside one Hajj meaning-block.',
      },
      anchors: [
    ...
    rhetoric: [
      {
        ...
        ru: {
          ...
          evidence: 'ٱلْحَجُّ أَشْهُرٌ مَّعْلُومَاتٌ построено как именная конструкция: ٱلْحَجُّ — тема высказывания, أَشْهُرٌ — сообщение о ней, مَّعْلُومَاتٌ — характеристика этих месяцев.',
          mechanism: 'Фраза сначала устанавливает рамку как данность. Здесь ещё нет повеления и нет условия: слушателю сначала задают устойчивую исходную точку, от которой дальше будет развиваться правило.',
          effect: 'Поэтому следующее فَمَنْ воспринимается как ответвление от уже установленной рамки: сначала названо время хаджа, затем речь переходит к тому, кто входит в это время и принимает на себя хадж.',
        },
        en: {
          step: '01',
          label: 'ESTABLISHED FRAME',
          title: 'Hajj is placed within known months',
          evidence: 'ٱلْحَجُّ أَشْهُرٌ مَّعْلُومَاتٌ is a nominal construction: ٱلْحَجُّ is the topic, أَشْهُرٌ gives the predicate, and مَّعْلُومَاتٌ qualifies those months.',
          ...
          effect: 'The following فَمَنْ can therefore be heard as a branch from an established frame: first the time of Hajj is stated, then the discourse turns to the person who enters that time and undertakes Hajj.',
        },
      },
      {
        id: 'rhetoric-limits',
        ...
        ru: {
          ...
          evidence: 'مَنْ (man) вводит условие. В فَلَا частица فَ размечена как فاء واقعة في جواب الشرط — она открывает результат условия. Следующие وَلَا и وَلَا начинаются уже с وَ, которую Corpus размечает как обычное сочинительное присоединение.',
          mechanism: 'Здесь хорошо видно различие فَ и وَ. وَ просто присоединяет следующий элемент и сама по себе не задаёт отношение «это следует как результат». فَ связывает условие и его ответ теснее: «кто вступил в хадж — тогда…». После этого وَ присоединяет ещё два ограничения внутрь уже открытой рамки ответа.',
          effect: 'Поэтому одна فَ фактически задаёт грамматическую рамку всей серии فَلَا … وَلَا … وَلَا. Три ограничения читаются не как отдельные запреты, а как один связанный набор последствий вступления в состояние хаджа.',
          sound: 'Повтор لَا делает эту единую грамматическую серию слышимой: فَلَا … وَلَا … وَلَا.',
        },
        en: {
          step: '02',
          label: 'CONDITION → ONE CHAIN',
          title: 'Entering Hajj is tied to three boundaries',
          evidence: 'مَنْ (man) introduces a condition. In فَلَا, فَ is marked as فاء واقعة في جواب الشرط, opening the result of that condition. The following وَلَا and وَلَا begin with وَ, marked by the Corpus as ordinary coordination.',
          mechanism: 'The contrast between فَ and وَ is visible here. وَ simply joins another element and does not by itself mark it as a result. فَ binds condition and response more tightly: “whoever enters Hajj—then…”. وَ then adds the second and third limits inside that already-opened result frame.',
          ...
          sound: 'Repeated لَا makes the single grammatical series audible: فَلَا … وَلَا … وَلَا.',
        },
      },
      {
        id: 'rhetoric-knowledge',
        range: [16, 21],
        focusWords: [16, 17, 20, 21],
        ru: {
          step: '03',
          label: 'ДЕЙСТВИЕ → ЗНАНИЕ',
          title: 'Любое добро грамматически связано со знанием Аллаха',
          evidence: 'وَمَا تَفْعَلُوا… открывается وَ, а внутри самой фразы مَا является условным словом. يَعْلَمْهُ стоит в ответе этого условия: «что бы вы ни сделали из добра — Аллах знает это».',
          mechanism: 'Здесь وَ не делает предыдущие запреты причиной следующей фразы; она присоединяет новый шаг речи. Но внутри этого шага условная конструкция сама создаёт жёсткую связь: действие человека → يَعْلَمْهُ ٱللَّهُ.',
          effect: 'Знание Аллаха оказывается не отдельным комментарием после правил. Грамматика делает его постоянным ответом на человеческое действие: какое бы добро ни произошло, оно уже находится в Его знании.',
        },
        en: {
          step: '03',
          label: 'ACTION → KNOWLEDGE',
          title: 'Every good act is grammatically tied to Allah’s knowledge',
          evidence: 'وَمَا تَفْعَلُوا… begins with وَ, while inside the clause مَا is conditional. يَعْلَمْهُ stands in the response to that condition: “whatever good you do—Allah knows it.”',
          mechanism: 'Here وَ does not make the previous prohibitions the cause of the next statement; it adds a new discourse step. Inside that step, however, the conditional structure creates a firm link: human action → يَعْلَمْهُ ٱللَّهُ.',
          effect: 'Allah’s knowledge is therefore not a detached comment after the rules. The grammar makes it the standing response to human action: whatever good occurs is already within His knowledge.',
        },
      },
      {
        id: 'rhetoric-provision',
        range: [22, 26],
        focusWords: [22, 23, 25, 26],
        ru: {
          step: '04',
          label: 'ПОВЕЛЕНИЕ → УСИЛЕННОЕ ПОЯСНЕНИЕ',
          title: 'Практическая подготовка сразу связывается с تَقْوَىٰ',
          evidence: 'وَتَزَوَّدُوا начинается с وَ и вводит новое повеление: подготовиться к пути. Затем следует فَإِنَّ: Corpus размечает فَ как استئنافية, а إِنَّ — как частицу усиленного утверждения.',
          mechanism: 'Сравнение снова важно: وَ добавляет новое действие к ходу аята, а فَ даёт следующей фразе более тесное следование. Здесь это не отдельное событие во времени, а близкое присоединение объяснения к повелению. Одновременно وَتَزَوَّدُوا и ٱلزَّادِ повторяют корень ز و د.',
          effect: 'Поэтому мысль не распадается на «возьмите припасы» и потом случайную фразу о taqwā. Сам язык сцепляет действие, понятие زَاد и усиленное утверждение о том, что лучшим زَاد названа تَقْوَىٰ.',
          sound: 'وَتَزَوَّدُوا ↔ ٱلزَّادِ дают слышимую однокоренную перекличку и поддерживают эту связь.',
        },
        en: {
          step: '04',
          label: 'COMMAND → EMPHATIC EXPLANATION',
          title: 'Practical preparation is immediately tied to تَقْوَىٰ',
          evidence: 'وَتَزَوَّدُوا begins with وَ and introduces a new command to prepare for the journey. It is followed by فَإِنَّ: the Corpus marks فَ as استئنافية and إِنَّ as an emphatic particle.',
          mechanism: 'The contrast matters again: وَ adds a new action to the discourse, while فَ gives the next clause a closer sequence. Here this is not a separate event in time but a tightly attached explanation of the command. وَتَزَوَّدُوا and ٱلزَّادِ also repeat the root ز و د.',
          effect: 'The thought therefore does not split into “take provisions” and an unrelated sentence about taqwā. The wording itself binds the action, the noun زَاد, and the emphatic assertion that تَقْوَىٰ is the best زَاد.',
          sound: 'وَتَزَوَّدُوا ↔ ٱلزَّادِ creates an audible root echo that supports the same link.',
        },
      },
      {
        id: 'rhetoric-address',
        ...
        ru: {
          step: '05',
          label: 'ПОНЯТИЕ → ДЕЙСТВИЕ → ОБРАЩЕНИЕ',
          title: 'تَقْوَىٰ сразу превращается в практическое требование',
          evidence: 'ٱلتَّقْوَىٰ — существительное. В следующем وَٱتَّقُونِ возвращается тот же корень و ق ي уже в повелительной форме. Затем يَا вводит прямое обращение к أُولِي ٱلْأَلْبَابِ.',
          mechanism: 'Здесь связь создаёт не فَ, а повтор одного корня и смена формы: качество → действие. وَ присоединяет повеление к предыдущему утверждению, а يَا затем переключает речь с объяснения на непосредственное обращение к слушателю.',
          effect: 'تَقْوَىٰ не остаётся термином внутри определения «лучшего запаса». Она тут же получает практическую форму: сохранять осознанность перед Аллахом и оберегать поступки в установленных Им границах. Обращение к людям разумения подчёркивает необходимость понять эту связь.',
          sound: 'ٱلتَّقْوَىٰ ↔ وَٱتَّقُونِ дают соседнее корневое эхо: переход от качества к действию слышен в самой форме слов.',
        },
        en: {
          step: '05',
          label: 'CONCEPT → ACTION → DIRECT ADDRESS',
          title: 'تَقْوَىٰ immediately becomes a practical demand',
          evidence: 'ٱلتَّقْوَىٰ is a noun. In the following وَٱتَّقُونِ the same root و ق ي returns in an imperative form. يَا then opens a direct address to أُولِي ٱلْأَلْبَابِ.',
          mechanism: 'The link here is not created by فَ but by repetition of one root with a change of form: quality → action. وَ joins the command to the preceding assertion, while يَا then shifts from explanation to direct address.',
          effect: 'تَقْوَىٰ does not remain a term inside the definition of the “best provision.” It immediately takes practical form: conscious awareness before Allah and guarding one’s conduct within His boundaries. Addressing people of understanding stresses the need to grasp this link.',
          sound: 'ٱلتَّقْوَىٰ ↔ وَٱتَّقُونِ creates an adjacent root echo, making the movement from quality to action audible in the word forms themselves.',
        },
      },
    ],
  },
