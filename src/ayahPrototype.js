export const AYAH_PROTOTYPES = {
  '2:197': {
    ...
    rhetoric: [
      {
        id: 'rhetoric-entering',
        range: [1, 15],
        focusWords: [4, 8, 10, 12],
        ru: {
          step: '01',
          label: 'ОБЩАЯ РАМКА → ЛИЧНОЕ УСЛОВИЕ',
          title: 'Из «есть время хаджа» — в «если ты вошёл в него»',
          story: 'Аят сначала спокойно устанавливает факт: для хаджа есть известные месяцы. Затем فَمَنْ резко приближает эту рамку к человеку: «тогда кто вступил в хадж…». Это уже не информация о календаре, а ситуация, в которой находится конкретный паломник.',
          mechanism: 'فَ в فَمَنْ — فاء استئنافية: она открывает следующий шаг мысли. Затем فَ в فَلَا уже другая — فاء جواب الشرط: если человек вступил в хадж, то именно отсюда следуют названные ограничения.',
          effect: 'Поэтому فَلَا ощущается сильнее простого «не делайте»: запреты поданы как прямое следствие принятого состояния хаджа. А وَلَا … وَلَا не начинают новые правила, а наращивают один и тот же ответ условия.',
          sound: 'فَلَا … وَلَا … وَلَا делает три ограничения одной слышимой серией.',
        },
        en: {
          step: '01',
          label: 'GENERAL FRAME → PERSONAL CONDITION',
          title: 'From “Hajj has its time” to “if you enter it”',
          story: 'The ayah first states calmly that Hajj has known months. فَمَنْ then pulls that frame toward the individual: “then whoever enters Hajj…”. The statement is no longer only about the calendar; it becomes the situation of a particular pilgrim.',
          mechanism: 'The فَ in فَمَنْ is فاء استئنافية, opening the next movement. The فَ in فَلَا is different: فاء جواب الشرط, linking entry into Hajj to the resulting limits.',
          effect: 'So فَلَا carries more force than an isolated “do not”: the prohibitions are presented as consequences of entering the state of Hajj. وَلَا … وَلَا then extend the same conditional answer rather than beginning unrelated rules.',
          sound: 'فَلَا … وَلَا … وَلَا makes the three limits one audible series.',
        },
      },
      {
        ...
        ru: {
          step: '02',
          label: 'ОТ ГРАНИЦ → К ОСОЗНАНИЮ',
          title: 'Почему после запретов появляется «Аллах знает»',
          story: 'После трёх конкретных границ аят не продолжает список запретов. Он меняет перспективу: وَمَا تَفْعَلُوا مِنْ خَيْرٍ يَعْلَمْهُ ٱللَّهُ — что бы вы ни сделали из добра, Аллах знает это.',
          mechanism: 'مَا условная и обобщающая: речь открывается к любому добру, а не к одному поступку. Фраза завершается يَعْلَمْهُ ٱللَّهُ, поэтому центр оказывается не на самом перечне действий, а на знании Аллаха о них.',
          effect: 'Так правила хаджа перестают выглядеть внешним контролем. Человек действует в установленном состоянии, зная, что его выборы находятся перед знанием Аллаха. Именно эта осознанность подготавливает появление تَقْوَىٰ.',
        },
        en: {
          step: '02',
          label: 'FROM LIMITS → TO AWARENESS',
          title: 'Why “Allah knows” comes after the prohibitions',
          story: 'After three concrete limits, the ayah does not continue the list. It changes perspective: وَمَا تَفْعَلُوا مِنْ خَيْرٍ يَعْلَمْهُ ٱللَّهُ—whatever good you do, Allah knows it.',
          mechanism: 'مَا is conditional and generalizing, opening the statement to any good deed rather than one action. The clause lands on يَعْلَمْهُ ٱللَّهُ, shifting the center from a list of acts to Allah’s knowledge of them.',
          effect: 'The Hajj rules therefore stop looking like external control alone. A person acts within an appointed state while knowing that choices are before Allah’s knowledge. That awareness prepares the arrival of تَقْوَىٰ.',
        },
      },
      {
        id: 'rhetoric-taqwa',
        ...
        ru: {
          step: '03',
          label: 'ВНЕШНЯЯ ПОДГОТОВКА → ВНУТРЕННЯЯ',
          title: 'Почему после «берите припасы» появляется taqwā',
          story: 'وَتَزَوَّدُوا звучит как очень практическое повеление: подготовьтесь к дороге. Но فَإِنَّ тут же раскрывает, какой «запас» важнее всего: خَيْرَ ٱلزَّادِ ٱلتَّقْوَىٰ.',
          mechanism: 'فَ в فَإِنَّ присоединяет объясняющую фразу к повелению; إِنَّ усиливает утверждение. Одновременно وَتَزَوَّدُوا и ٱلزَّادِ повторяют корень ز و د, поэтому действие «запастись» и понятие «запас» сцеплены и смыслом, и формой.',
          effect: 'На фоне предыдущего «Аллах знает» taqwā становится логичным внутренним обеспечением паломника: не просто знать ограничения, а сохранять осознанность перед Аллахом, которая помогает эти границы удерживать.',
          sound: 'وَتَزَوَّدُوا ↔ ٱلزَّادِ создают короткое корневое эхо перед словом تَقْوَىٰ.',
        },
        en: {
          step: '03',
          label: 'OUTWARD PREPARATION → INWARD PREPARATION',
          title: 'Why taqwā follows “take provisions”',
          story: 'وَتَزَوَّدُوا is strikingly practical: prepare for the journey. فَإِنَّ immediately explains what provision matters most: خَيْرَ ٱلزَّادِ ٱلتَّقْوَىٰ.',
          mechanism: 'The فَ in فَإِنَّ joins an explanatory statement to the command, while إِنَّ strengthens the assertion. وَتَزَوَّدُوا and ٱلزَّادِ also repeat the root ز و د, tying the act of taking provision to the noun “provision” in both meaning and form.',
          effect: 'Against the preceding “Allah knows,” taqwā becomes the pilgrim’s inward provision: not merely knowing the limits, but sustaining awareness before Allah that helps a person remain within them.',
          sound: 'وَتَزَوَّدُوا ↔ ٱلزَّادِ creates a short root echo immediately before تَقْوَىٰ.',
        },
      },
      {
        id: 'rhetoric-address',
        ...
        ru: {
          ...
          title: 'Почему аят не заканчивается на слове taqwā',
          story: 'Сначала تَقْوَىٰ названа как лучший внутренний запас. Следующее وَٱتَّقُونِ сразу возвращает тот же корень و ق ي уже как повеление: качество превращается в действие.',
          mechanism: 'Корневой повтор связывает существительное تَقْوَىٰ и глагол ٱتَّقُوا. Затем يَا أُولِي ٱلْأَلْبَابِ меняет дистанцию ещё раз: аят прямо зовёт «обладателей разумения».',
          effect: 'Финал собирает всю предыдущую логику: установленный путь, границы, знание Аллаха и taqwā должны быть не просто поняты, а осознанно приняты. Обращение к разумению делает вывод рефлексивным: увидеть связь между внешним правилом и внутренним состоянием.',
          sound: 'ٱلتَّقْوَىٰ ↔ وَٱتَّقُونِ делает переход от качества к действию слышимым.',
        },
        en: {
          step: '04',
          label: 'CONCEPT → ACTION → DIRECT ADDRESS',
          title: 'Why the ayah does not end with the word taqwā',
          story: 'تَقْوَىٰ is first named as the best inward provision. وَٱتَّقُونِ immediately brings the same root و ق ي back as an imperative, turning the quality into action.',
          mechanism: 'The root echo links the noun تَقْوَىٰ to the verb ٱتَّقُوا. يَا أُولِي ٱلْأَلْبَابِ then changes the distance once more by directly calling people of understanding.',
          effect: 'The ending gathers the whole logic of the ayah: appointed path, boundaries, Allah’s knowledge, and taqwā are not merely to be heard but consciously grasped. The address to understanding makes the conclusion reflective: see the link between outward rule and inward state.',
          sound: 'ٱلتَّقْوَىٰ ↔ وَٱتَّقُونِ makes the move from quality to action audible.',
        },
      },
    ],
  },
