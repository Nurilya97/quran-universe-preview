...
export const AYAH_PROTOTYPES = {
  '2:197': {
    ...
    journey: {
      ru: {
        guide: 'Хадж — в известные месяцы. Кто в эти месяцы вступил в хадж, пусть во время хаджа избегает непристойности, неповиновения и споров. Какое бы добро вы ни сделали, Аллах знает его. Запасайтесь; лучший запас — taqwā. И сохраняйте taqwā передо Мной, о обладатели глубокого разумения.',
        guideNote: 'Это смысловой ориентир Quran Universe: он удерживает ход аята целиком и сохраняет ключевое понятие taqwā, не сводя его заранее к одному русскому слову.',
      },
      en: {
        guide: 'Hajj takes place in known months. Whoever enters Hajj in them should avoid indecency, disobedience and disputing during Hajj. Whatever good you do, Allah knows it. Take provision; the best provision is taqwā. And keep taqwā before Me, O people of deep understanding.',
        guideNote: 'This is the Quran Universe meaning guide: it keeps the movement of the ayah in view while preserving taqwā as a key term rather than forcing it into one English equivalent.',
      },
      segments: [
        {
          id: 'time',
          range: [1, 3],
          ru: {
            meaning: 'Хадж связан с известными месяцами.',
            note: 'Аят сначала задаёт временную рамку всего дальнейшего наставления.',
          },
          en: {
            meaning: 'Hajj is tied to known months.',
            note: 'The ayah first establishes the time-frame for everything that follows.',
          },
        },
        {
          ...
          range: [4, 15],
          ru: {
            meaning: 'Вступление в хадж означает определённые границы поведения.',
            note: 'После решения совершить хадж называются три ограничения: rafath, fusūq и jidāl — непристойность, неповиновение и спор.',
          },
          en: {
            meaning: 'Entering Hajj brings specific boundaries of conduct.',
            note: 'Once Hajj is undertaken, three limits are named: rafath, fusūq and jidāl — indecency, disobedience and disputing.',
          },
        },
        {
          id: 'knowledge',
          range: [16, 21],
          ru: {
            meaning: 'Любое совершённое добро известно Аллаху.',
            note: 'Взгляд расширяется от запретов к поступкам человека вообще: добро не остаётся незамеченным.',
          },
          en: {
            meaning: 'Whatever good is done is known to Allah.',
            note: 'The view widens from the prohibitions to human action more generally: good is not unseen.',
          },
        },
        {
          id: 'provision-taqwa',
          range: [22, 26],
          ru: {
            meaning: 'Наряду с дорожным запасом аят называет лучший внутренний запас — taqwā.',
            note: 'Внешняя подготовка к пути становится переходом к внутреннему состоянию человека.',
          },
          en: {
            meaning: 'Alongside travel provision, the ayah names the best inward provision — taqwā.',
            note: 'Outward preparation for the journey becomes a transition to the person’s inward orientation.',
          },
        },
        {
          id: 'direct-address',
          range: [27, 29],
          ru: {
            meaning: 'Taqwā сразу превращается из названного качества в прямое обращение к людям разумения.',
            note: 'Тот же корень возвращается в повелении وَٱتَّقُونِ, а финал обращён к أُولِي ٱلْأَلْبَابِ — обладателям глубокого разумения.',
          },
          en: {
            meaning: 'Taqwā immediately moves from a named quality into a direct address to people of deep understanding.',
            note: 'The same root returns in the command وَٱتَّقُونِ, and the close addresses أُولِي ٱلْأَلْبَابِ — people of deep understanding.',
          },
        },
      ],
    },
    tokens: [
      ...
      },
      {
        ...
        noteEn: 'وَٱتَّقُونِ (wa-ittaqūni) brings the same root و ق ي back as a direct imperative to a plural audience.',
        analysis: {
          ru: {
            morphology: {
              parts: [
                { ar: 'وَ', tr: 'wa-', label: 'союз, соединяющий с предыдущим утверждением' },
                { ar: 'ٱتَّقُوا', tr: 'ittaqū', label: 'повеление VIII формы · 2 л. мн. ч.' },
          ...
          en: {
            morphology: {
              parts: [
                { ar: 'وَ', tr: 'wa-', label: 'conjunction linking to the preceding statement' },
                { ar: 'ٱتَّقُوا', tr: 'ittaqū', label: 'Form VIII imperative · 2nd person plural' },
    ...
    blocks: [
      ...
      },
      {
        ...
        range: [27, 29],
        ru: {
          title: 'Taqwā превращается в прямое требование',
    ...
    rhetoric: [
      ...
      },
      {
        ...
        ru: {
          ...
          mechanism: 'На уровне хода мысли فَ fa тесно связывает повеление с последующим пояснением: запасайтесь — ведь лучший запас назван تَقْوَىٰ taqwā. إِنَّ inna усиливает это утверждение. Связь дополнительно поддерживает повтор корня ز و د z-w-d в وَتَزَوَّدُوا wa-tazawwadū и ٱلزَّادِ al-zād: сначала человек готовит запас для пути, затем раскрывается, какой запас назван лучшим.',
        ...
        en: {
          ...
          mechanism: 'At the discourse level, فَ fa tightly links the command to the following explanation: take provision—for the best provision is named as تَقْوَىٰ taqwā. إِنَّ inna reinforces that assertion. The link is further supported by the repeated root ز و د z-w-d in وَتَزَوَّدُوا wa-tazawwadū and ٱلزَّادِ al-zād: first the person prepares provision for the journey, then the ayah identifies which provision is best.',
