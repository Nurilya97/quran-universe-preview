  ...
  '2:197': {
    ...
    passageLens: {
      ru: {
        ...
        thread: 'Для 2:197 особенно важно, что 2:196 завершается وَاتَّقُوا ٱللَّهَ وَٱعْلَمُوا wa-ttaqū Allāha wa-ʿlamū («сохраняйте осознанность перед Аллахом и знайте…»), внутри 2:197 стоят يَعْلَمْهُ ٱللَّهُ yaʿlamhu Allāh («Аллах знает это»), ٱلتَّقْوَىٰ al-taqwā («благочестие; осознанность перед Аллахом») и وَٱتَّقُونِ wa-ittaqūni («сохраняйте осознанность передо Мной»), а 2:203 снова возвращает وَاتَّقُوا ٱللَّهَ وَٱعْلَمُوا wa-ttaqū Allāha wa-ʿlamū («сохраняйте осознанность перед Аллахом и знайте…»). Так taqwā и знание проходят через хадж-блок как связанные ориентиры.',
        sound: 'Внутри этого же смыслового блока есть простая звуковая перекличка концовок: 2:196 — ٱلْعِقَابِ al-ʿiqāb («наказание»), 2:197 — ٱلْأَلْبَابِ al-albāb («обладающие разумением / разумы»), 2:202 — ٱلْحِسَابِ al-ḥisāb («расчёт»). При остановке во всех трёх слышится окончание -āb с конечным ب b. Это не рифма каждого аята 2:196–203, а три заметные звуковые точки внутри одного тематического блока о хадже.',
      },
      en: {
        ...
        thread: 'For 2:197 it is especially useful that 2:196 closes with وَاتَّقُوا ٱللَّهَ وَٱعْلَمُوا wa-ttaqū Allāha wa-ʿlamū (“remain consciously mindful before Allah and know…”), 2:197 contains يَعْلَمْهُ ٱللَّهُ yaʿlamhu Allāh (“Allah knows it”), ٱلتَّقْوَىٰ al-taqwā (“piety; conscious awareness before Allah”), and وَٱتَّقُونِ wa-ittaqūni (“remain consciously mindful before Me”), while 2:203 returns to وَاتَّقُوا ٱللَّهَ وَٱعْلَمُوا wa-ttaqū Allāha wa-ʿlamū (“remain consciously mindful before Allah and know…”). Taqwā and knowledge thus recur across the Hajj passage as linked orientations.',
        sound: 'Within the same meaning-block there is a simple correspondence in the endings: 2:196 — ٱلْعِقَابِ al-ʿiqāb (“punishment”), 2:197 — ٱلْأَلْبَابِ al-albāb (“people of understanding / intellects”), and 2:202 — ٱلْحِسَابِ al-ḥisāb (“account”). At pause, all three end audibly in -āb with final ب b. This is not the rhyme of every ayah in 2:196–203, but three noticeable sound-points inside one Hajj meaning-block.',
      },
      anchors: [
    ...
    rhetoric: [
      ...
      },
      {
        ...
        ru: {
          ...
          evidence: 'Фраза وَمَا تَفْعَلُوا начинается с وَ, а внутри неё مَا вводит условие. يَعْلَمْهُ стоит в ответе этого условия: وَمَا تَفْعَلُوا … يَعْلَمْهُ ٱللَّهُ.',
          mechanism: 'Здесь وَ не делает предыдущие ограничения причиной следующей фразы; она присоединяет новый шаг речи. Но внутри этого шага условная конструкция сама создаёт жёсткую связь: مَا تَفْعَلُوا → يَعْلَمْهُ ٱللَّهُ.',
        ...
        en: {
          ...
          evidence: 'The phrase وَمَا تَفْعَلُوا begins with وَ, while inside it مَا introduces the condition. يَعْلَمْهُ stands in the response: وَمَا تَفْعَلُوا … يَعْلَمْهُ ٱللَّهُ.',
          mechanism: 'Here وَ does not make the previous limits the cause of the next statement; it adds a new discourse step. Inside that step, however, the conditional structure creates a firm link: مَا تَفْعَلُوا → يَعْلَمْهُ ٱللَّهُ.',
      ...
      },
      {
        ...
        ru: {
          ...
          evidence: 'وَتَزَوَّدُوا начинается с وَ и вводит новое повеление. Затем следует فَإِنَّ: فَ тесно присоединяет следующий шаг, а إِنَّ усиливает утверждение.',
          mechanism: 'Сравнение снова важно: وَ добавляет новое действие к ходу аята, а فَ даёт следующей фразе более тесное следование. Одновременно وَتَزَوَّدُوا и ٱلزَّادِ повторяют корень ز و د.',
          effect: 'Поэтому мысль не распадается на «возьмите припасы» и затем случайную фразу о تَقْوَىٰ. Сам язык сцепляет действие, понятие زَاد и усиленное утверждение о том, что лучшим زَاد названа تَقْوَىٰ.',
        },
        en: {
          step: '04',
          label: 'COMMAND → EMPHATIC EXPLANATION',
          title: 'Practical preparation is immediately tied to تَقْوَىٰ',
          evidence: 'وَتَزَوَّدُوا begins with وَ and introduces a new command. It is followed by فَإِنَّ: فَ tightly joins the next step, while إِنَّ strengthens the assertion.',
          mechanism: 'The contrast matters again: وَ adds a new action to the discourse, while فَ gives the next clause a closer sequence. وَتَزَوَّدُوا and ٱلزَّادِ also repeat the root ز و د.',
          effect: 'The thought therefore does not split into “take provisions” and an unrelated sentence about تَقْوَىٰ. The wording itself binds the action, the noun زَاد, and the emphatic assertion that تَقْوَىٰ is the best زَاد.',
        },
      },
      {
        id: 'rhetoric-address',
        ...
        ru: {
          ...
          effect: 'تَقْوَىٰ не остаётся термином внутри определения «лучшего запаса». Она тут же получает практическую форму: сохранять осознанность перед Аллахом и оберегать поступки в установленных Им границах. Обращение к أُولِي ٱلْأَلْبَابِ подчёркивает необходимость понять эту связь.',
        },
        en: {
          step: '05',
          ...
          effect: 'تَقْوَىٰ does not remain a term inside the definition of the “best provision.” It immediately takes practical form: conscious awareness before Allah and guarding one’s conduct within His boundaries. Addressing أُولِي ٱلْأَلْبَابِ stresses the need to grasp this link.',
        },
      },
    ],
  },
