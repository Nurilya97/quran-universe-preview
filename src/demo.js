...
export const COPY = {
  ru: {
    ...
    orbitRingLegend: 'кольцо — словообразовательная семья',
    quranColorLegend: 'встречается в Коране',
    formNumberLegend: 'глагольная форма семьи',
    innerOrbitLegend: 'пунктир — дополнительная зона той же I семьи',
  ...
  en: {
    ...
    orbitRingLegend: 'ring — derivational family',
    quranColorLegend: 'attested in the Quran',
    formNumberLegend: 'verb form of the family',
    innerOrbitLegend: 'dashed ring — extra zone of the same Form I family',
