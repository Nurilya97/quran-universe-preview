...
export const FORMS = [
  ...
  { id: 'lablab', arabic: 'لَبْلَب', reading: 'lablab', orbit: 'LBBX', type: 'adjective', angle: 45, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, definitionRu: 'Добрый и благожелательный к семье и соседям.', definitionEn: 'Kind and beneficent to one’s family and neighbours.' },
  { id: 'bilabalib', arabic: 'بِلَبَالِبِ', reading: 'bilabālibi', orbit: 'LBBX', type: 'lexicalForm', angle: 90, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, definitionRu: 'Форма в выражениях о глубокой сердечной привязанности; لَبَالِب также обозначает смешанный шум овец или коз.', definitionEn: 'A form used in expressions of deep heartfelt affection; لَبَالِب also denotes the confused cries of sheep or goats.' },
  { id: 'lablabaNoun', arabic: 'لَبْلَبَة', reading: 'lablaba', orbit: 'LBBX', type: 'noun', angle: 135, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, definitionRu: 'Звукоподражательное слово для крика козла во время гона.', definitionEn: 'An imitative word for the cry of a he-goat at rutting-time.' },
  { id: 'lablabPlant', arabic: 'لَبْلَاب', reading: 'lablāb', orbit: 'LBBX', type: 'noun', angle: 180, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, definitionRu: 'Название вьющегося растения в одной из словарных статей.', definitionEn: 'A name for a climbing plant in one lexical entry.' },
  { id: 'lawlab', arabic: 'لَوْلَب', reading: 'lawlab', orbit: 'LBBX', type: 'lexicalForm', angle: 225, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, definitionRu: 'Отдельная словарная форма, перекрёстно индексируемая рядом с этой семьёй.', definitionEn: 'A separate lexical form cross-indexed with this family.' },
  { id: 'labibGarment', arabic: 'لَبِيبَة', reading: 'labība', orbit: 'LBBX', type: 'noun', angle: 270, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, definitionRu: 'Название определённого вида одежды.', definitionEn: 'The name of a particular kind of garment.' },
  { id: 'lababaPasture', arabic: 'لَبَابَة', reading: 'labāba', orbit: 'LBBX', type: 'noun', angle: 315, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, definitionRu: 'Небольшое количество пастбища / растительности — словарное употребление.', definitionEn: 'A small amount of pasture or herbage — a lexical usage.' },
]
