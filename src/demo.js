...
export const FORMS = [
  ...
  { id: 'lubb', arabic: 'لُبّ', reading: 'lubb', orbit: 'LBBI', type: 'noun', angle: 0, radius: 29, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'core', definitionRu: 'Сердцевина, ядро, внутренняя мякоть; чистая или лучшая часть; у человека — разум, понимание.', definitionEn: 'Core, kernel, inner pulp; pure or choicest part; in a person, understanding or intellect.' },
  { id: 'albab', arabic: 'أَلْبَاب', reading: 'albāb', orbit: 'LBBI', type: 'noun', angle: 60, radius: 23.5, source: 'lbbCorpus', rootKey: 'lbb', semanticBranch: 'core', definitionRu: 'Множественное от لُبّ; в Коране — «обладатели разумения / глубокого понимания».', definitionEn: 'Plural of لُبّ; in the Quran, “possessors of understanding / deep discernment.”' },
  { id: 'lubab', arabic: 'لُبَاب', reading: 'lubāb', orbit: 'LBBI', type: 'noun', angle: 40, radius: 29, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'core', definitionRu: 'Чистая, лучшая, отборная часть вещи; её суть.', definitionEn: 'The pure, best, or choicest part of a thing; its essence.' },
  { id: 'labib', arabic: 'لَبِيب', reading: 'labīb', orbit: 'LBBI', type: 'adjective', angle: 100, radius: 23.5, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'core', definitionRu: 'Разумный, проницательный человек — тот, кто обладает لُبّ.', definitionEn: 'An intelligent, discerning person — one who possesses لُبّ.' },
  { id: 'lababa', arabic: 'لَبَابَة', reading: 'labāba', orbit: 'LBBI', type: 'noun', angle: 80, radius: 29, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'core', definitionRu: 'Лَبَابَة: словарная форма, связанная с لَبَاب; в линии разума — разумность / проницательность.', definitionEn: 'لَبَابَة: a lexical form related to لَبَاب; in the understanding-line, intelligence / discernment.' },
  { id: 'labbNoun', arabic: 'لَبّ', reading: 'labb', orbit: 'LBBI', type: 'noun', angle: 140, radius: 23.5, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'stay', definitionRu: 'Масдар от لَبَّ «оставаться»: пребывание, удерживание при ком-либо или при чём-либо; отсюда одна из линий объяснения لَبَّيْكَ.', definitionEn: 'A verbal noun of لَبَّ “to remain”: remaining or staying in attendance; from this comes one traditional explanation of لَبَّيْكَ.' },
  { id: 'ulbub', arabic: 'أُلْبُوب', reading: 'ulbūb', orbit: 'LBBI', type: 'noun', angle: 120, radius: 29, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'core', definitionRu: 'Съедобная внутренняя часть косточки или плода — буквальный образ внутреннего ядра.', definitionEn: 'The edible inner part of a stone or fruit — a literal image of the inner kernel.' },
  { id: 'lababPasture', arabic: 'لَبَاب', reading: 'labāb', orbit: 'LBBI', type: 'noun', angle: 160, radius: 29, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'stay', definitionRu: 'Небольшой участок пастбища или растительности; также входит в устойчивое выражение لَبَابِ لَبَابِ.', definitionEn: 'A small amount of pasture or herbage; also used in the fixed expression لَبَابِ لَبَابِ.' },

  // Additional nominal forms
  { id: 'labab', arabic: 'لَبَب', reading: 'labab', orbit: 'LBBI', type: 'noun', angle: 180, radius: 23.5, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'chest', definitionRu: 'لَبَب: верхняя часть груди; нагрудный ремень животного, удерживающий седло; также передняя / тонкая часть песчаного холма.', definitionEn: 'لَبَب: the upper chest; a breast-girth that keeps a saddle from slipping; also the fore/thin part of a sand-hill.' },
  { id: 'labbaChest', arabic: 'لَبَّة', reading: 'labba', orbit: 'LBBI', type: 'noun', angle: 200, radius: 29, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'chest', definitionRu: 'لَبَّة: впадина в верхней части груди между ключицами, прямо под горлом; место, где лежит ожерелье.', definitionEn: 'لَبَّة: the hollow at the upper chest between the collarbones, just below the throat; the place where a necklace rests.' },
  { id: 'libaba', arabic: 'لِبَابَة', reading: 'libāba', orbit: 'LBBI', type: 'noun', angle: 220, radius: 23.5, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'chest', definitionRu: 'Одежда или накидка, которую надевают поверх и собирают на верхней части груди и плечах.', definitionEn: 'A garment or drapery worn over other clothing and gathered over the upper chest and shoulders.' },
  { id: 'labiba', arabic: 'لَبِيبَة', reading: 'labība', orbit: 'LBBI', type: 'noun', angle: 240, radius: 29, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'chest', definitionRu: 'Название определённого вида одежды; словарь сопоставляет её с بَقِيرَة.', definitionEn: 'The name of a particular kind of garment, compared in the lexicon with بَقِيرَة.' },
  { id: 'malbub', arabic: 'مَلْبُوب', reading: 'malbūb', orbit: 'LBBI', type: 'adjective', angle: 300, radius: 23.5, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'chest', definitionRu: 'Животное, на котором закреплён нагрудный ремень لَبَب.', definitionEn: 'A beast fitted with a لَبَب breast-girth.' },
  { id: 'mulabb', arabic: 'مُلَبّ', reading: 'mulabb', orbit: 'LBBI', type: 'adjective', angle: 320, radius: 29, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'chest', definitionRu: 'Животное, снабжённое нагрудным ремнём لَبَب.', definitionEn: 'A beast furnished with a لَبَب breast-girth.' },
  { id: 'mulbab', arabic: 'مُلْبَب', reading: 'mulbab', orbit: 'LBBI', type: 'adjective', angle: 340, radius: 23.5, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'chest', definitionRu: 'Животное, снабжённое нагрудным ремнём لَبَب.', definitionEn: 'A beast furnished with a لَبَب breast-girth.' },

  // Other entries indexed in the classical lexical family
  { id: 'talbib', arabic: 'تَلْبِيب', reading: 'talbīb', orbit: 'LBBII', type: 'noun', angle: 180, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'chest', definitionRu: 'Тَلْبِيب: часть одежды у верхней груди; выражение أَخَذَ بِتَلْبِيبِهِ означает схватить человека за эту часть одежды у груди / за ворот и потянуть.', definitionEn: 'تَلْبِيب: the portion of clothing at the upper chest; أَخَذَ بِتَلْبِيبِهِ means to seize a person by that part of the garment / collar and pull.' },
