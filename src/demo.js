...
export const FORMS = [
  ...
  { id: 'labbaba', arabic: 'لَبَّبَ', reading: 'labbaba', orbit: 'LBBII', type: 'verbII', angle: 140, source: 'arabicLexiconLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'mixed', definitionRu: 'II форма: о зерне — сформировать / развить внутреннюю сердцевину; о человеке и одежде — собрать одежду у груди или схватить за эту часть одежды и потянуть.', definitionEn: 'Form II: of grain, to form or develop an inner kernel; of a person/clothing, to gather the garment at the chest or seize that part of the garment and pull.' },
  { id: 'alabba', arabic: 'أَلَبَّ', reading: 'alabba', orbit: 'LBBIV', type: 'verbIV', angle: 135, source: 'arabicLexiconLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'mixed', definitionRu: 'IV форма: о посеве — когда в нём появляется съедобная сердцевина; о месте или деле — оставаться при нём, держаться его и не отходить.', definitionEn: 'Form IV: of crops, when the edible inner part develops; of a place or matter, to remain with it, keep to it, and not leave.' },
  ...
  { id: 'lababa', arabic: 'لَبَابَة', reading: 'labāba', orbit: 'LBBI', type: 'verbalNoun', angle: 112.5, radius: 32, source: 'lisanLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'core', definitionRu: 'Масдар линии لَبَّ / لَبِيب: становление обладателем لُبّ — разумения, проницательности. В словарях то же написание также встречается в отдельном значении «небольшое пастбище / немного травы»; эти значения здесь не смешиваются.', definitionEn: 'A verbal noun in the لَبَّ / لَبِيب line: becoming possessed of لُبّ — understanding or discernment. Lexicons also record the same spelling in a separate sense “a little pasture/herbage”; the two senses are kept distinct here.' },
  ...
  { id: 'lababPasture', arabic: 'لَبَاب', reading: 'labāb', orbit: 'LBBI', type: 'noun', angle: 202.5, radius: 32, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'separate', definitionRu: 'Отдельное словарное значение: небольшое количество пастбища или травы. Также фиксируется выражение لَبَابِ لَبَابِ — «не бойся / всё в порядке» в контексте благожелательного отношения.', definitionEn: 'A separate attested lexical sense: a small amount of pasture or herbage. The expression لَبَابِ لَبَابِ is also recorded in a reassuring/favourable sense, roughly “no harm / all is well.”' },
  ...
  { id: 'labiba', arabic: 'لَبِيبَة', reading: 'labība', orbit: 'LBBI', type: 'noun', angle: 292.5, radius: 32, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'garment', definitionRu: 'Название определённого вида одежды; Lane определяет её через сопоставление с بَقِيرَة. Это самостоятельное засвидетельствованное словарное значение.', definitionEn: 'The name of a particular kind of garment; Lane defines it by comparison with بَقِيرَة. It is retained as a distinct attested lexical sense.' },
  { id: 'malbub', arabic: 'مَلْبُوب', reading: 'malbūb', orbit: 'LBBI', type: 'adjective', angle: 270, radius: 23, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'mixed', definitionRu: 'مَـ задаёт место / носителя, где проявляется корневой смысл; مَفْعُول уточняет, что действие или состояние реализовано на этом носителе. Словари фиксируют два значения: «обладающий разумением, характеризуемый لُبّ» и «животное, на котором закреплён нагрудный ремень لَبَب».', definitionEn: 'مَـ marks the locus / bearer where the root meaning manifests; مَفْعُول specifies that the action or state is realised on that bearer. Lexicons record two senses: “characterised by understanding, possessing لُبّ” and “a beast fitted with a لَبَب breast-girth.”' },
  { id: 'mulabb', arabic: 'مُلَبّ', reading: 'mulabb', orbit: 'LBBI', type: 'adjective', angle: 337.5, radius: 32, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'chest', definitionRu: 'Носитель / обладатель признака этой производной формы: здесь животное, снабжённое لَبَب — нагрудным ремнём.', definitionEn: 'The bearer of the state expressed by this derived form: here, a beast furnished with a لَبَب breast-girth.' },
  { id: 'mulbab', arabic: 'مُلْبَب', reading: 'mulbab', orbit: 'LBBI', type: 'adjective', angle: 315, radius: 23, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'chest', definitionRu: 'Носитель / обладатель состояния, выраженного этой формой: словарный вариант для животного, снабжённого нагрудным ремнём لَبَب.', definitionEn: 'The bearer of the state expressed by this form: an attested variant for a beast fitted with a لَبَب breast-girth.' },
