...
export const FORMS = [
  ...
  { id: 'malbub', arabic: 'مَلْبُوب', reading: 'malbūb', orbit: 'LBBI', type: 'adjective', angle: 270, radius: 23, source: 'laneLbb', rootKey: 'lbb', lexicalOnly: true, semanticBranch: 'mixed', definitionRu: 'Словари фиксируют два значения: «обладающий разумением / характеризуемый لُبّ» и «животное, на котором закреплён нагрудный ремень لَبَب».', definitionEn: 'Lexicons record two senses: “characterised by understanding / possessing لُبّ” and “a beast fitted with a لَبَب breast-girth.”' },
