...
export const COPY = {
  ru: {
    ...
    close: 'Закрыть', references: 'Вхождения в Коране', referenceNote: 'Список по группировке Коранического арабского корпуса: включая изменённые формы слова. Ссылка на аят открывает Quran.com, номер слова — точный разбор в корпусе.',
  ...
  en: {
    ...
    close: 'Close', references: 'Quranic occurrences', referenceNote: 'Grouped as in the Quranic Arabic Corpus, including inflected forms. Verse links open Quran.com; word numbers open the exact Corpus analysis.',
