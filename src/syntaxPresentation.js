  ...
  return {
    ...
    steps: [
      { id: 'inna', from: 23, to: 24, active: [23, 24],
        ...
        ru: 'إِنَّ (inna) вводит усиленное утверждение. خَيْرَ (khayra) — его именная часть, اسم إِنَّ (ism inna). После إِنَّ это слово находится в состоянии manṣūb (винительном); здесь оно слышится и пишется с окончанием -a: khayra.',
      ...
      { id: 'idafa', from: 24, to: 25, active: [24, 25],
        ...
        ru: 'ٱلزَّادِ (al-zādi) уточняет خَيْرَ (khayra): вместе получается «лучший запас». Это идафа: خَيْرَ — muḍāf, а ٱلزَّادِ — muḍāf ilayhi. Второе слово находится в состоянии majrūr (родительном); здесь это видно по окончанию -i: al-zādi.',
      ...
      { id: 'predicate', from: 24, to: 26, active: [24, 25, 26], group: [24, 25],
        ...
        ru: 'ٱلتَّقْوَىٰ (al-taqwā) завершает утверждение о خَيْرَ ٱلزَّادِ (khayra al-zādi) — «лучшем запасе»: сообщает, чем он является. Здесь ٱلتَّقْوَىٰ выполняет роль خبر إِنَّ (khabar inna) и находится в состоянии marfūʿ (именительном). Из-за конечной ىٰ (alif maqṣūra) ожидаемая ḍamma не проявляется на письме.',
