...
export const WQY_PUBLIC_MODEL = {
  ...
  rootNucleus: {
    ru: 'Фундаментальное значение корня — ограждать / защищать, не позволяя вреду достигнуть защищаемого. На базовом уровне корень объединяет действие защиты, того, кто защищает, средство защиты и сохранение от вреда. В производных формах это защитное ядро развивается дальше: в линии ٱتَّقَىٰ (ittaqā) → تَقْوَىٰ (taqwā) оно становится внутренней защитной позицией человека, а кораническое употребление раскрывает её через осознанность перед Всевышним, различение, трепет, внимание к границам и сознательный выбор.',
    en: 'The fundamental meaning of the root is to protect / shield by preventing harm from reaching what is protected. At the basic level, the root brings together the act of protection, the protector, a means of protection, and preservation from harm. In derived forms this protective core develops further: in the line ٱتَّقَىٰ (ittaqā) → تَقْوَىٰ (taqwā), it becomes an inner protective stance, while Quranic usage unfolds it through awareness before the Most High, discernment, awe, attention to boundaries, and conscious choice.',
  },
  operativeMechanism: {
