...
export const WQY_PUBLIC_MODEL = {
  ...
  translationFidelity: {
    ...
    ru: {
      ...
      devotion: '«Набожность» — допустимая контекстная передача преданности Аллаху и стремления жить в соответствии с Его предписаниями; она не покрывает всю концепцию автоматически.',
      ...
      awareness: '«Осознанность перед Аллахом» — допустимая контекстная передача внимания, памятования и выбора перед Аллахом; она не является универсальным эквивалентом для каждого аята.',
