...
export const MORPHOLOGY = {
  ...
  taqwa: {
    ...
    pattern: {
      ...
      ru: { title: 'Именная модель', text: 'تَقْوَىٰ имеет собственную именную модель فَعْلَى. Конечная ىٰ принадлежит модели; изменения корневых و и ي показаны отдельно в словообразовании.' },
      en: { title: 'Nominal pattern', text: 'تَقْوَىٰ has its own nominal pattern فَعْلَى. Final ىٰ belongs to the pattern; the changes involving root و and ي are shown separately in the derivational sequence.' },
    },
    formation: {
      ru: 'تَقْوَىٰ (taqwā) словообразовательно связано с ٱتَّقَىٰ (ittaqā), но само существительное имеет модель فَعْلَى. Для наглядного разбора букв можно развернуть реконструкцию как وَقْيَا: первая و — первая корневая буква, ق — вторая, ي — третья. Затем начальная و заменяется на ت: وَقْيَا → تَقْيَا. После этого конечная корневая ي в имени на فَعْلَى заменяется на و: تَقْيَا → تَقْوَىٰ. Классические источники могут описывать промежуточный порядок иначе, но обе замены остаются теми же: начальная و связана с ت, а конечная корневая ي — с و после ق.',
      en: 'تَقْوَىٰ (taqwā) is derivationally related to ٱتَّقَىٰ (ittaqā), while the noun itself follows the pattern فَعْلَى. For a transparent letter-by-letter explanation, the reconstruction can be unfolded as وَقْيَا: initial و is the first root letter, ق the second, and ي the third. The initial و is then represented as ت: وَقْيَا → تَقْيَا. Next, the final root ي in a noun on فَعْلَى is represented as و: تَقْيَا → تَقْوَىٰ. Classical sources may present the intermediate ordering differently, but the same two correspondences remain: initial و with ت, and final root ي with the و after ق.',
    },
    evolution: [
      { ar: 'و ق ي', reading: 'w-q-y', metaRu: 'корень', metaEn: 'root' },
  ...
  malbub: {
    ...
    components: [
      { role: 'prefix', ar: 'مَـ', reading: 'ma-', ru: 'مَـ показывает место проявления корневого смысла. Это может быть буквальное место или то, на чём действие проявилось и закрепилось. Остальная форма уточняет эту связь.', en: 'مَـ marks the locus / bearer where the root meaning manifests: what the action or state appears on and becomes established in. The rest of the pattern specifies the nature of that relation.' },
    ],
    derivedFrom: null,
    pattern: {
  ...
  mulabb: {
    ...
    components: [
      { role: 'prefix', ar: 'مُـ', reading: 'mu-', ru: 'مُـ показывает носителя корневого смысла — того, кто им обладает или в ком он проявляется. Остальная форма уточняет, как именно.', en: 'مُـ adds the meaning of a bearer / possessor of the root action or quality: the one in whom that meaning manifests. The rest of the pattern specifies the relation.' },
    ],
    derivedFrom: {
  ...
  mulbab: {
    ...
    components: [
      { role: 'prefix', ar: 'مُـ', reading: 'mu-', ru: 'مُـ показывает носителя корневого смысла. Здесь это тот, кто снабжён لَبَب.', en: 'مُـ points to the bearer / possessor of the manifested root meaning; here, the bearer of the state “fitted with لَبَب”.' },
    ],
    derivedFrom: {
      ar: 'لَبَب', reading: 'labab', metaRu: 'нагрудный ремень', metaEn: 'breast-girth',
