...
export const LBB_ROOT_CONTENT = {
  ru: {
    ...
    body: 'В словарном гнезде ل ب ب представлены значения сердцевины и чистой части вещи, разума и разумения, верхней части груди и места ожерелья, нагрудного ремня, захвата за одежду у груди, пребывания и удерживания на месте. Среди производных встречаются لُبّ، لُبَاب، لَبِيب، لَبَابَة، أَلْبَاب، لَبَّبَ، أَلَبَّ، تَلَبَّبَ، اِسْتَلَبَّ и другие формы.',
  },
  en: {
    lead: 'ل ب ب (l-b-b) — the inner, pure core; when applied to a person, purified and deep understanding.',
    body: 'The lexical family ل ب ب includes senses of an inner core or pure part, understanding and intellect, the upper chest and necklace area, a breast-girth, grasping clothing at the chest, and remaining or keeping to a place. Its derivatives include لُبّ، لُبَاب، لَبِيب، لَبَابَة، أَلْبَاب، لَبَّبَ، أَلَبَّ، تَلَبَّبَ، اِسْتَلَبَّ and other forms.',
  },
  rootNucleus: {
    ...
    ru: [
      {
        ...
        items: [
          { term: 'لَبَّ / لَبِبَ', definition: 'Стать обладателем لُبّ; быть разумным. Также словари фиксируют значения пребывания и удерживания на месте.' },
          { term: 'لَبَّبَ', definition: 'Стянуть одежду у груди; схватить за ворот или переднюю часть одежды; также о зерне — приобрести внутреннюю мякоть / сердцевину.' },
          { term: 'أَلَبَّ', definition: 'Оставаться, пребывать, держаться чего-либо; также о зерне — наполниться съедобной внутренней частью.' },
          { term: 'تَلَبَّبَ', definition: 'Подпоясаться, собрать одежду на груди, приготовиться; также пройти через долину.' },
          { term: 'اِسْتَلَبَّ', definition: 'Испытать чей-либо لُبّ — разум, понимание.' },
          { term: 'لَبْلَبَ / لَبْلَبَة', definition: 'Редуплицированные формы, зафиксированные в словарном гнезде с отдельными употреблениями.' },
        ],
      },
      {
        title: 'Именные и описательные формы',
        items: [
          { term: 'لَبّ', definition: 'Пребывание, удерживание при чём-либо; служение / послушание в устойчивых выражениях.' },
          { term: 'لُبّ', definition: 'Сердцевина, ядро, внутренняя мякоть; чистая или отборная часть; разум, понимание.' },
          { term: 'لُبُوب', definition: 'Множественное от لُبّ в значении внутренних частей / сердцевин.' },
          { term: 'أَلْبَاب', definition: 'Множественное от لُبّ в значении разумов / способностей разумения; кораническая форма.' },
          { term: 'لَبَاب', definition: 'Небольшой участок пастбища / растительности; также форма в устойчивом выражении لَبَابِ لَبَابِ.' },
          { term: 'لُبَاب', definition: 'Чистая, лучшая, отборная часть; суть.' },
          { term: 'لَبَابَة', definition: 'Разумность, проницательность; обладание لُبّ.' },
          { term: 'لَبِيب', definition: 'Разумный, проницательный, обладающий пониманием.' },
          { term: 'أَلِبَّاء', definition: 'Множественное от لَبِيب.' },
          { term: 'لَبِيبَة', definition: 'Название определённого вида одежды.' },
          { term: 'مَلْبُوب', definition: 'Описанный как обладающий разумением; также форма, связанная с захватом / стягиванием одежды.' },
          { term: 'لَبَب', definition: 'Верхняя часть груди; место нагрудного ремня; также передняя или тонкая часть песчаного холма.' },
          { term: 'لَبَّة', definition: 'Область верхней груди / горла, место ожерелья.' },
          { term: 'تَلْبِيب', definition: 'Место или действие собирания одежды у груди; захват за ворот.' },
          { term: 'لِبَابَة', definition: 'Одежда или накидка, которую собирают / закрепляют на верхней части груди и плечах.' },
          { term: 'لَبْلَب', definition: 'Добрый и благожелательный к семье и соседям.' },
          { term: 'بِلَبَالِبِ', definition: 'Форма, встречающаяся в выражениях о глубине сердца / внутреннем чувстве.' },
          { term: 'لَبْلَبَة', definition: 'Редуплицированная форма с отдельными словарными значениями.' },
          { term: 'لَبْلَاب', definition: 'Вьющееся растение, обвивающее деревья.' },
          { term: 'لَوْلَب', definition: 'Отдельная словарная форма, индексируемая в этой семье; значение раскрывается в словарной статье.' },
          { term: 'أُلْبُوب', definition: 'Съедобная внутренняя часть косточки / плода в одном из словарных употреблений.' },
          { term: 'مُلَبّ', definition: 'Зафиксированная производная именная форма.' },
          { term: 'مُلْبَب', definition: 'Зафиксированная производная именная форма.' },
        ],
      },
    ],
    en: [
      {
        title: 'Verbal forms',
        items: [
          { term: 'لَبَّ / لَبِبَ', definition: 'To become possessed of لُبّ; to be intelligent. Lexicons also record remaining or keeping to a place.' },
          { term: 'لَبَّبَ', definition: 'To gather clothing at the chest; seize by the collar/front of a garment; also of grain, to develop an inner kernel.' },
          { term: 'أَلَبَّ', definition: 'To remain, stay, or keep to something; also of grain, to develop edible inner substance.' },
          { term: 'تَلَبَّبَ', definition: 'To gird oneself, gather clothing at the chest, make ready; also to traverse a valley.' },
          { term: 'اِسْتَلَبَّ', definition: 'To test a person’s لُبّ — understanding or intelligence.' },
          { term: 'لَبْلَبَ / لَبْلَبَة', definition: 'Reduplicated forms recorded in the lexical family with separate usages.' },
        ],
      },
      {
        title: 'Nominal and descriptive forms',
        items: [
          { term: 'لَبّ', definition: 'Remaining or keeping to something; service / obedience in established expressions.' },
          { term: 'لُبّ', definition: 'Core, kernel, inner pulp; pure or choicest part; understanding or intellect.' },
          { term: 'لُبُوب', definition: 'Plural of لُبّ in the sense of inner parts or kernels.' },
          { term: 'أَلْبَاب', definition: 'Plural of لُبّ in the sense of understandings / intellects; the Quranic form.' },
          { term: 'لَبَاب', definition: 'A small amount of pasture or herbage; also used in the expression لَبَابِ لَبَابِ.' },
          { term: 'لُبَاب', definition: 'Pure, best, or choicest part; essence.' },
          { term: 'لَبَابَة', definition: 'Intelligence or discernment; possession of لُبّ.' },
          { term: 'لَبِيب', definition: 'Intelligent, discerning, possessing understanding.' },
          { term: 'أَلِبَّاء', definition: 'Plural of لَبِيب.' },
          { term: 'لَبِيبَة', definition: 'The name of a particular kind of garment.' },
          { term: 'مَلْبُوب', definition: 'Described as possessing understanding; also a form connected with being seized or bound by clothing.' },
          { term: 'لَبَب', definition: 'Upper chest; breast-girth area; also the fore or thin part of a sand-hill.' },
          { term: 'لَبَّة', definition: 'Upper chest / throat area, the place of a necklace.' },
          { term: 'تَلْبِيب', definition: 'The place or act of gathering clothing at the chest; seizing by the collar.' },
          { term: 'لِبَابَة', definition: 'A garment or drapery gathered over the upper chest and shoulders.' },
          { term: 'لَبْلَب', definition: 'Kind and beneficent to one’s family and neighbours.' },
          { term: 'بِلَبَالِبِ', definition: 'A form occurring in expressions referring to the depths of the heart / inward feeling.' },
          { term: 'لَبْلَبَة', definition: 'A reduplicated form with separate lexical usages.' },
          { term: 'لَبْلَاب', definition: 'A climbing plant that twines around trees.' },
          { term: 'لَوْلَب', definition: 'A separate form indexed with this lexical family; its definition is given in its dictionary entry.' },
          { term: 'أُلْبُوب', definition: 'The edible inner part of a stone/fruit in one lexical usage.' },
          { term: 'مُلَبّ', definition: 'A recorded derived nominal form.' },
          { term: 'مُلْبَب', definition: 'A recorded derived nominal form.' },
        ],
      },
    ],
  },
