    ...
    ru: [
      ...
      },
      {
        ...
        items: [
          ...
          { term: 'لَبِيبَة', definition: 'Женская форма от لَبِيب; также отдельные словарные употребления.' },
          ...
          { term: 'لِبَابَة', definition: 'Одна из зафиксированных именных форм словарного гнезда.' },
          { term: 'لَبْلَب', definition: 'Отдельная редуплицированная именная форма.' },
          { term: 'لَبْلَبَة', definition: 'Редуплицированная форма с отдельными словарными значениями.' },
          { term: 'لَبْلَاب', definition: 'Название вьющегося растения.' },
          { term: 'لَوْلَب', definition: 'Спираль / винтовая форма; отдельная словарная форма.' },
    ...
    en: [
      ...
      },
      {
        ...
        items: [
          ...
          { term: 'لَبِيبَة', definition: 'Feminine form of لَبِيب; also recorded in separate lexical usages.' },
          ...
          { term: 'لِبَابَة', definition: 'A nominal form recorded in the lexical family.' },
          { term: 'لَبْلَب', definition: 'A separate reduplicated nominal form.' },
          { term: 'لَبْلَبَة', definition: 'A reduplicated form with separate lexical usages.' },
          { term: 'لَبْلَاب', definition: 'A name for a climbing plant.' },
          { term: 'لَوْلَب', definition: 'A spiral / screw-like form; a separate lexical form.' },
