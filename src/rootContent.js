    ...
    meaningMap: [
      ...
      },
      {
        ...
        ru: { title: 'Проявления', description: 'Вера и осознанность становятся видимыми в действиях человека.', items: [
          { term: 'Благочестие', definition: 'Нравственное качество, проявляющееся в почтительном отношении к вере и в поведении, согласованном с её предписаниями. Здесь это одно из поведенческих проявлений تَقْوَىٰ (taqwā), а не полное определение самого понятия.' },
