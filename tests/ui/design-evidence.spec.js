...
test('design evidence · word Quran panel · mobile', async ({ page }, testInfo) => {
  ...
  await openSearch(page, 'taqwa')
  await page.locator('.node-quran').click()
  await expect(page.locator('.detail-sheet-quran.is-open')).toBeVisible()
...
test('design evidence · word Meaning panel · mobile', async ({ page }, testInfo) => {
  ...
  await expect(page.locator('.detail-sheet-meaning.is-open')).toBeVisible()
...
test('design evidence · Root forms panel · mobile', async ({ page }, testInfo) => {
  ...
  await expect(page.locator('.detail-sheet-forms.is-open')).toBeVisible()
